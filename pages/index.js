      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 p-4 md:px-20 text-center">
        <section className=" p-4" aria-label="Introduction">
          ...
          <div className="mb-20 hidden md:block flex flex-col">
            ...
            <a
              href="https://github.com/johnpolacek/cardtable"
        ...
        >
          <p className="pb-6">
            <strong>CardTable</strong> is a table component that renders as an
          ...
          <p className="pb-3">
            You can view all the code for these examples at{" "}
            <a
              href="https://github.com/johnpolacek/cardtable"
              className="text-blue-600 font-bold underline"
            >
              github.com/johnpolacek/cardtable
            </a>
          </p>
        </section>
      </main>
